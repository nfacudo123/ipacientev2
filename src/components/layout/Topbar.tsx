          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="relative inline-flex items-center">
                <BellRing className="w-6 h-6 text-gray-500 dark:text-gray-400 hover:text-[#9b87f5] transition-colors animate-pulse" />
                <span className="absolute -top-2 -right-2 inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-500 rounded-full">
                  2
                </span>
              </button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-80 bg-[hsl(var(--card))] border border-gray-100 dark:border-gray-800">
              <div className="px-4 py-3 font-medium text-[#7E69AB] dark:text-gray-300">
                Notificaciones
              </div>
              <DropdownMenuSeparator className="bg-gray-100 dark:bg-gray-800" />
              <div className="max-h-[300px] overflow-auto">
                <DropdownMenuItem className="p-4 focus:bg-[#F8F7FF] dark:focus:bg-gray-800/50">
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      <BellRing className="w-5 h-5 text-[#9b87f5] mt-0.5 animate-pulse" />
                      <div>
                ...
                <DropdownMenuItem className="p-4 focus:bg-[#F8F7FF] dark:focus:bg-gray-800/50">
                  <div className="space-y-2">
                    <div className="flex items-start gap-2">
                      <BellRing className="w-5 h-5 text-[#9b87f5] mt-0.5" />
                      <div>
                        <p className="font-medium text-gray-800 dark:text-gray-200">
                          Cita Julio 11 a las 11:00 am
                        </p>
